        ...
        try {
            ...
            if (["approved", "pending", "rejected"].includes(data.status)) {
                ...
                switch (data.status) {
                    case "pending":
                        setMessage(
                            "Your store request is pending, please wait for admin to approve your store request."
                        );
                        break;
                    case "approved":
                        setMessage(
                            "Your store request is approved, you can now add products to your store from dashboard."
                        );
                        setTimeout(() => router.push("/store"), 5000);
                        break;
                    case "rejected":
                        setMessage(
                            "Your store request is rejected, please contact admin for more information."
                        );
                    default:
                        break;
                }
        ...
        return (
            <div className="min-h-[80vh] mx-6 flex items-center justify-center text-slate-400">
                <h1 className="text-2xl sm:text-4xl font-semibold">
                    Please <span className="text-slate-500">Login</span> to
                    continue!
                </h1>
            </div>
        );
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="max-w-lg">
                                To become a seller on GoCart, submit your store
                                details for review. Your store will be activated
